...
from models import AE_B_Attention2
...
def parse_option():
    ...
    # io
    parser.add_argument('--checkpoint_path', default='eval_result/logs_parsec_crossAttention_random/ckpt_epoch_30000.pth',help='Model checkpoint path')
    parser.add_argument('--log_dir', default='./test_result/logs_parsec_crossAttention_random',
    ...
    def test(self,args):
        ...
        for step, data in enumerate(test_loader):
            ...
            with torch.no_grad():
                ...
                x_gt = x_gt.to(device)
                # # AE
                output = model(x_sample,x_physics) # [b,200,2],[b,10,2]
                data = x_gt
