...
from models import AE_A_variable,AE_B_Attention,AE_AB
...
def parse_option():
    ...
    # io
    parser.add_argument('--checkpoint_path_A', default='./eval_result/logs_edit_A/cond_ckpt_epoch_210.pth',help='Model checkpoint path')

    parser.add_argument('--checkpoint_path_B', default='./eval_result/logs_parsec_attention/ckpt_epoch_10000.pth',help='Model checkpoint path')

    parser.add_argument('--log_dir', default='./eval_result/logs_edit_AB',
                        help='Dump dir to save model checkpoint')
    parser.add_argument('--val_freq', type=int, default=5)  # epoch-wise
    parser.add_argument('--save_freq', type=int, default=25)  # epoch-wise
...
class Trainer:
    ...
    def get_datasets(self):
        """获得训练、验证 数据集"""
        train_dataset = EditingAirFoilDataset(split='train')
        val_dataset = EditingAirFoilDataset(split='val')
    ...
    def main(self,args):
        ...
        if args.checkpoint_path_A != 'none':
        ...
        if args.checkpoint_path_B != 'none':
