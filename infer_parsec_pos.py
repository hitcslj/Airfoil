...
def parse_option():
    ...
    # io
    parser.add_argument('--checkpoint_path', default='eval_result/logs_parsec_pos/ckpt_epoch_20000.pth',help='Model checkpoint path')
    parser.add_argument('--log_dir', default='./test_result/logs_parsec_pos',
