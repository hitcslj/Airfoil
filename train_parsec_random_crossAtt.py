...
def parse_option():
    ...
    parser.add_argument('--log_dir', default='./eval_result/logs_parsec_crossAttention_random',
...
class Trainer:
    ...
    def get_datasets(self):
        """获得训练、验证 数据集"""
        train_dataset = AirFoilDatasetRandom(split='train')
        val_dataset = AirFoilDatasetRandom(split='val')
