...
from models import AE_A_variable
...
def parse_option():
    ...
    parser.add_argument('--log_dir', default='./eval_result/logs_edit_A',
...
class Trainer:
    ...
    def train_one_epoch(self,model,optimizer,criterion,dataloader,device,epoch,args):
        ...
        for _,data in enumerate(tqdm(dataloader)):
            ...
            x_gt = data['gt'].unsqueeze(-1) # [b,10,1]
            ...
            # # AE
            pred = model(x_sample, x_editing, x_physics) # [b,20,2],[b,20,2],[b,10,2]
