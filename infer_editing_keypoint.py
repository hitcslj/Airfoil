...
from models import AE_AB,AE_A_Keypoint,CVAE
...
def parse_option():
    ...
    # io
    parser.add_argument('--checkpoint_path', default='eval_result/logs_edit_keypoint_AB_cvae/cond_ckpt_epoch_1000.pth',help='Model checkpoint path')

    parser.add_argument('--log_dir', default='test_result/editing_keypoint',
...
class Tester:
    ...
    def evaluate_one_epoch(self, model,criterion, dataloader,device, epoch, args):
        ...
        for _,data in enumerate(test_loader):
            ...
            target_param = target_param.unsqueeze(-1) #[b,10,1]
    ...
    def test(self,args):
        ...
        for step, data in enumerate(test_loader):
            ...
            with torch.no_grad():
                ...
                ans = model.refine_forward(source_keypoint, target_keypoint, source_param,refine_iteration=refine_iteration)
