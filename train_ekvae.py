...
def parse_option():
    ...
    # io
    parser.add_argument('--checkpoint_path', default='logs/ek_vae/ckpt_epoch_1000.pth',help='Model checkpoint path')  
    parser.add_argument('--log_dir', default='logs/ek_vae',
...
class Trainer:
    ...
    def train_one_epoch(self,model,optimizer,dataloader,device,epoch,args):
        ...
        for _,data in enumerate(tqdm(dataloader)):
            ...
            condition = torch.cat([source_param,source_keypoint-target_keypoint],dim=1) # [b,37,1]
            ...
            recon_batch, mu, logvar = model(gt,condition)  # [b,11],[b,37] -> [b,11]
