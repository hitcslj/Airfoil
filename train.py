...
def parse_option():
    ...
    parser.add_argument('--log_dir', default='./eval_result/logs',
...
class Trainer:
    ...
    def get_datasets(self):
        """获得训练、验证 数据集"""
        train_dataset = AirFoilDataset(split='train')
        val_dataset = AirFoilDataset(split='val')
    ...
    def train_one_epoch(self,model,optimizer,criterion,dataloader,device,epoch,args):
        ...
        for _,data in enumerate(tqdm(dataloader)):
            ...
            # # AE
            # outputDict = model(data) # [b,200,2]
            # l2 = L2(outputDict['ae_input'],outputDict['ae_output'])
            # l1 = L1(outputDict['output'],data)
            # loss = l1 + l2
